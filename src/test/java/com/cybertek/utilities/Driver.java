...
public class Driver {
    ...
    We make it static, because we want it to run before everething else, and also we will use it in a static method
     */
    private static WebDriver driver;

    /**
     * Creating re-usable utility method that will return same driver instance every time we call it
     */
